...
//
// Metal stub for the replay-capture API (genmlx-7prh): capture is
// CUDA-only until measured on Metal (the genmlx-lmmn discipline). begin()
// returning nullptr routes callers onto the plain compiled-replay path.
